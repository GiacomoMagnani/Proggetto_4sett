...
struct ricetta* add_ingr (struct ricetta* head, char* ric, char* ing, int qnt){
...
struct lotto* add_lotto (struct lotto* head, char* ing, int qnt, int scd){
            ...
            if (ricetta_alredy_exist(head_ric, ric) == 1) {
                ...
                *boo = 0;
                do{
                    ...
                    head_ric = add_ingr(head_ric, ric, ing, qnt);
                } while(*boo == 0);
                free(boo);
            ...
            *boo = 0;
            ...
            do{
                ...
                if (head_rif == NULL){
                    ...
                    head_rif = add_lotto(head_rif, ing, qnt, scd);
                }
            } while(*boo == 0);
            free(boo);
